...
iks * iks_find_child(iks *x, const char *name);
...
typedef int (iksSendHook)(void *user_data, const char *data, size_t size);
...
uint32_t iks_crc32(uint32_t crc, const uint8_t *buf, uint32_t len);
